...
function ConnectionList(props) {
  ...
  const [idToggleFollowers, setIdToggleFollowers] = useState(
    "invisible-border"
  );
  ...
  return (
    <div className="container connection-container">
      <div className="row connection-row-header">
        <div
          className="col-md-6 connection-col-header-left"
          id={idToggleFollowers}
        >
          <button
            className="btn btn-link follower-btn"
            id={btnToggleFollowers}
          ...
          {props.followers.map((follower) => {
            return (
              <div className="row connection-li-row" id={follower.id}>
                ...
                <div
                  className="col-md-7 connection-text-col"
                  id={follower.id}
