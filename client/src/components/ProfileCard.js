  ...
  return (
    <div className="card profile-card-top">
      <div className="card-body profile-card-body-top">
        ...
        <Row>
          <div className="card profile-pic-card" style={imgStyle}>
            <div className="card profile-pic-card-body" id={props.visibleEdits}>
              <button
                className="btn btn-link profile-pic-card-body-text"
        ...
        <Row>
          <p className="profile-realname-text">
            {props.firstName} {props.lastName}
          </p>
        </Row>
        <Row>
          <p className="profile-membersince-text">
            Member Since {props.joinDate}
          </p>
        </Row>
        <Row>
          <button
            className="btn btn-link follow-btn"
            id={props.visibleAdd}
            name={props.name}
            onClick={props.followUser}
          >
            Follow {props.firstName}
          </button>
        </Row>
      </div>
    </div>
