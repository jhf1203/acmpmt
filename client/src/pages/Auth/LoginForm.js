          ...
          <Col size="md-5">
            ...
            <div className="row definition-row">
              <p className="definition-text">
                Crate digging is an art unto itself, a treasure hunt for
                something personally meaningful. The record store is the
                excavation site, the records are the artifacts that tell the
                story. It is musical archeology, cultural anthropology.
              </p>
            </div>
          </Col>
        </div>
              ...
              <Col size="md-6">
                <div className="card login-card">
                  ...
                  <p className="desc-body">
                    you give us three that you <span className="do">do</span>{" "}
                    like
                  </p>
                  <p className="desc-body">
                    we give you three that you{" "}
                    <span className="will">will</span> like.
                  </p>
                  <p className="desc-body">
                    you see who likes what you do like
                  </p>
                  <p className="desc-body">
                    you see who likes what you will like
                  </p>
              ...
              <Col size="md-6">
                <div className="card login-card">
                  <form style={{ marginTop: 10 }}>
                    ...
                    <div>
                      <Link to="/signup">
                        <div className="btn btn-link signup-btn">register</div>{" "}
                      </Link>
                    </div>
                  </form>
                </div>
